        ...
        children: [
          Expanded(
            child: Builder(
              builder: (context) {
                ...
                return Column(
                  children: [
                    // Reserved for FE05 floating damage numbers. Keeping this
                    // outside the board also prevents tall unit art from
                    // visually touching the HUD health bars.
                    const SizedBox(
          ...
          ConstrainedBox(
            ...
            child: GameAssetButton(
              ...
              disabledReason: skipSubmitted ? 'ส่งผลการทดสอบแล้ว' : null,
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(
